...
- **Self-initiated calls accounted for a large portion of all records**, but differed significantly in nature and response dynamics from public-initiated calls. Separating these categories was essential for accurately measuring response times, assessing service reliability, and interpreting resource allocation.
...
- **A significant number of calls lacked arrival timestamps**, indicating either officer non-response or data entry gaps. These unserved calls were analyzed separately, as their exclusion from response time calculations ensured more accurate timing metrics and highlighted potential service gaps. 
...
These pie charts illustrate the proportion of **all calls — both public-initiated and police-initiated — that went unserved** (i.e., no recorded officer arrival) in the 3rd and 4th police districts between 2019 and 2022. While total call volumes decreased in 2020 during the height of the COVID-19 pandemic, the **percentage of unserved calls rose sharply**, reaching a peak of **21.4%** — the highest of any year analyzed.

However, this overall unserved rate was **driven almost entirely by police-initiated calls**, not public-initiated ones. As shown below, only **68 public-initiated calls went unserved** (only 0.014%) across the entire four-year period — a striking contrast that highlights a fundamental difference in how the NOPD responds to self-initiated activity versus direct public requests for help.

This finding stood out to me as an EMT, where it is extremely rare for a public call to go entirely unanswered. The data here reflects a similar pattern in police response: public-initiated calls were overwhelmingly served, even during times of crisis. What differs sharply, however, is the treatment of **self-initiated activity**. In EMS, self-initiated checks (like walk-ups or motor vehicle accidents happening right in front of us) are still treated as service calls with a strong expectation of follow-through, especially once patient contact is made. The contrast in the CAD data suggests that police services, particularly during periods of resource strain, may deprioritize or forgo certain types of **self-initiated enforcement activity**, such as officer-initiated traffic stops or patrol checks that don't stem from a 911 call — reflecting a different operational model of triage.

In 2020, the NOPD — like many agencies nationwide — likely faced **staffing shortages**, with officers out sick, quarantined, or reassigned. In response, departments may have implemented **triaging protocols**, prioritizing high-risk or life-threatening situations (e.g., violent crimes, domestic violence, or mental health crises), while allowing lower-priority **self-initiated checks or reports** to remain unserved or be administratively closed. These internal decisions often show up in CAD data as "unserved" due to the absence of an arrival timestamp — particularly if officers were pulled away to respond to higher-priority public calls.

By 2022, the unserved rate had decreased from its 2020 peak but remained above pre-pandemic levels, suggesting that **longer-term operational shifts** may still be affecting service delivery patterns — particularly in how departments handle self-initiated enforcement activity versus direct requests for help from the public.

*It is important to note that this analysis defines a call as "unserved" only if **no officer arrival was recorded**. Calls with dispositions such as "Gone on Arrival" or "Unfounded" still included a physical officer response, and are therefore classified as served in this dataset. This distinction reinforces that the unserved category truly reflects **calls where no officer ever reached the scene**.*
...
This project explored how police response patterns, call volume, and service delivery evolved in two of New Orleans' most active police districts from 2019 to 2022. Using over 450,000 cleaned CAD records, I examined how major events — such as the COVID-19 lockdown and Mardi Gras — influenced emergency service demand and how the NOPD allocated its resources in response.

Several themes emerged across the analysis. The **onset of the COVID-19 pandemic** in March 2020 caused sharp disruptions in call volume, response rates, and service consistency. Certain call types — including **domestic violence** — spiked briefly, while others like **traffic** and **property** crimes declined and did not fully return to pre-pandemic levels. These patterns appear linked to citywide lockdowns, mobility changes, and policy initiatives such as **Operation Golden Eagle**, which likely contributed to reduced traffic enforcement during specific periods.

A particularly unexpected finding involved the rate of **unserved 911 calls**, which initially appeared alarmingly high. Drawing on my **EMS background**, where nearly every call receives a response, I was surprised to see unserved rates above 20% in 2020. However, by separating **public-initiated** from **officer-initiated** calls, it became clear that the majority of unserved calls were self-initiated activities — like proactive patrols or administrative tasks — rather than public requests for help. In fact, only **68 public-initiated calls** across four years went unserved, indicating much stronger public service coverage than originally assumed.

Examining **response times** revealed patterns consistent with frontline experience: calls involving immediate risk or potential for risk, such as **medical and mental health** calls, **suspicious activity** calls, and **unknown/unclassified** calls were generally prioritized and handled more quickly than **property-related incidents**, which often receive lower urgency. These insights were clearer after careful categorization and contextual framing, particularly when distinguishing self-initiated from public calls. It is important to note that the *rate* of unserved vs. served calls remained elevated post-2020, suggesting longer-term impacts from operational or policy shifts.

Ultimately, this project was both a technical and personal endeavor. My experience in emergency response shaped the questions I asked, informed my interpretation of data anomalies, and fueled a commitment to understanding how effectively the system serves those in crisis. By transforming a raw and complex dataset into structured insights and compelling visuals, I aimed to create a tool not only for analysis, but also for **accountability, transparency, and informed decision-making** in public safety.

This work highlights the power of combining lived experience with analytical rigor, and the value of data not just for answering questions, but for asking better ones. Future research could extend these findings by exploring operational changes post-2022 or integrating community feedback to deepen understanding of police-public interactions.
